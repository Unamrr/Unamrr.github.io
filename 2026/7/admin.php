...
// HTTP авторизация (простая проверка)
...
// Обработка POST запросов (удаление, редактирование)
...
<?php if ($edit_data): ?>
<div class="edit-form">
    <h3>Редактирование записи #<?= htmlspecialchars($edit_data['id']) ?></h3>
    <form method="post">
        ...
        <input type="date" name="birth_date" value="<?= htmlspecialchars($edit_data['birth_date']) ?>" required><br>
        <label>Пол:</label><br>
        <select name="gender">
